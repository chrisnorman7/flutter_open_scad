...
/// A screen for editing a polyhedron.
class EditPolyhedronScreen extends ConsumerWidget {
  /// Create an instance.
  const EditPolyhedronScreen({
  ...
  Widget build(final BuildContext context, final WidgetRef ref) {
    ...
    assert(
      shapeType == ShapeType.polyhedron,
      // ignore: lines_longer_than_80_chars
      'The shape was not a polyhedron: Project filename: $projectFilename, module ID: ${moduleId}Id, shape ID: $shapeId, type ${shapeType.name}',
    );
    return const SimpleScaffold(
      title: 'Edit Polyhedron',
      body: NotImplemented(),
    );
  }
}
